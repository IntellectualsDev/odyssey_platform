...
import 'package:odyssey_platform/home/widgets/games_galery_dialog.dart';
  ...
  void openGalery() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        if (globals.signedIn.value) {
          return GamesGalleryDialog();
        } else {
          return AuthenticationDialog(
              message: "Please login to view all available games",
